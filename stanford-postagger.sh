...
java -mx2g -cp $ROOT_DIR/stanford-postagger.jar: edu.stanford.nlp.tagger.maxent.MaxentTagger -model $MODEL_PATH -textFile $input_path -outputFormat tsv -sentenceDelimiter newline -tokenize false > $input_path.tagged
